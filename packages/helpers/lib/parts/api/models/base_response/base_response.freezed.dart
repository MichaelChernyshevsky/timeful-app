...
abstract class $BaseResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({dynamic data, String msg});
}
...
class _$BaseResponseImpl implements _BaseResponse {
  const _$BaseResponseImpl({required this.data, required this.msg});
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, const DeepCollectionEquality().hash(data), msg);
